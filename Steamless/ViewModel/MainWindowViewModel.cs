...
namespace Steamless.ViewModel
{
    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel(IDataService dataService, LoggingService logService)
        {
            ...
            StreamReader strinput = new StreamReader("input.txt");
            ...
            this.AddLogMessage(this, new LogMessageEventArgs("Steamless (c) 2015 - 2020 atom0s [atom0s@live.com]", LogMessageType.Debug));
