...
Modded to use steamless with command line by "steamless_cmd.bat".
Put "steamless_cmd.bat" in steamless folder to use command line.
Also put file path into "input.txt" and run steamless,it will unpack the file in "input.txt".
